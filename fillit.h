...
# define P11(m, i, j, n) m[i][j+1]=n, m[i+1][j+1]=n, m[i+2][j+1]=n, m[i+2][j]=n
# define P12(m, i, j, n) m[i][j+1]=n, m[i+1][j]=n, m[i+1][j+1]=n, m[i+1][j+2]=n
# define P13(m, i, j, n) m[i][j]=n, m[i][j+1]=n, m[i][j+2]=n, m[i+1][j+1]=n
# define P14(m, i, j, n) m[i][j]=n, m[i+1][j]=n, m[i+1][j+1]=n, m[i+2][j]=n
# define P15(m, i, j, n) m[i][j+1]=n, m[i+1][j+1]=n, m[i+1][j]=n, m[i+2][j+1]=n
# define P16(m, i, j, n) m[i][j]=n, m[i][j+1]=n, m[i+1][j+1]=n, m[i+1][j+2]=n
# define P17(m, i, j, n) m[i][j+1]=n, m[i][j+2]=n, m[i+1][j]=n, m[i+1][j+1]=n
# define P18(m, i, j, n) m[i][j+1]=n, m[i+1][j+1]=n, m[i+1][j]=n, m[i+2][j]=n
# define P19(m, i, j, n) m[i][j]=n, m[i+1][j]=n, m[i+1][j+1]=n, m[i+2][j+1]=n
